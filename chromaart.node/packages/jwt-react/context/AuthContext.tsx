...
import type { TokenDataDto, UserDto } from "../types";

export type AuthContextProps = {
  user: UserDto | null;
  authenticateUser: (tokenDate: TokenDataDto) => Promise<void>;
...
export const AuthProvider: FC<AuthProviderProps> = ({ children }) => {
  ...
  const authenticateUser = async (tokenDate: TokenDataDto): Promise<void> => {
    setLoading(true);
